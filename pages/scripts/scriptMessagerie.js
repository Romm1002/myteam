...
function open_warn_message(){
    document.getElementById("warn-message-background").style.display = "flex";
}

function close_menu_signaler(){
    document.getElementById("warn-message-background").style.display = "none";
}